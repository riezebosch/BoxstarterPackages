...
$packageName= 'sql-server-express' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = '' # download url
$url64      = 'https://download.my.visualstudio.com/db/en_sql_server_2016_express_x64_8762243.exe?t=3e8c8697-f2ce-49c9-9b2c-ce8d6c5a8110&e=1465850551&h=a75769aeb47d3e27a94c8279b6920dca&su=1' # 64bit URL here or remove - if installer is both, use $url
...
$packageArgs = @{
  ...
  softwareName  = 'Microsoft SQL Server*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
